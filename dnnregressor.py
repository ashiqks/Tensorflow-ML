...
Original file is located at
    https://colab.research.google.com/drive/1lGgxsdtXN62yNqhGG-BVBx0VQa1NFsJh
"""
...
# instantiate estimator dnn regressor model with the feature columns defined earlier and the number of neurons on each hidden layer by passing on a list
estimator = tf.estimator.DNNRegressor(feature_columns=cont_feature_cols + age_bucketized_cols, hidden_units=[2056, 1024, 512, 256, 128], model_dir='DNN_train_2')
